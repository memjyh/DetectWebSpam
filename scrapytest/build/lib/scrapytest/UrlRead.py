...
import struct
import csv
file1 = open("2018-08-31-143130-1.csv","w",encoding='utf-8',newline='')
file2 = open("2018-08-31-143130-2.csv","w",encoding='utf-8',newline='')
file3 = open("2018-08-31-143130-3.csv","w",encoding='utf-8',newline='')
